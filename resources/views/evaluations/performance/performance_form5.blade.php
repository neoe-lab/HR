...
@section('content')
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('list-person-performance') }}">ประเมินสมรรถนะ</a>
                            </li>
        ...
        @php
            ...
            // K1 = ระดับปฏิบัติการ
            // K2 = ระดับชำนาญการ
            // K3 = ระดับชำนาญการพิเศษ
            // O1 = ระดับปฏิบัติงาน
            // O2 = ระดับชำนาญงาน
            // O3 = ระดับชำนาญงานพิเศษ
            $level = 1;
            $who_id = '011';
        @endphp
        <form action=" {{ route('answer') }}" method="post">
            ...
            <input type="hidden" name="who" value="{{ $who_id }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>คำอธิบาย :
                                    ความมุ่งมั่นจะปฏิบัติราชการให้ดีหรือให้เกินมาตรฐานที่มีอยู่โดยมาตรฐานนี้อาจเป็นผลการปฏิบัติงานที่ผ่านมาของตนเองหรือเกณฑ์วัดผลสัมฤทธิ์ที่ส่วนราชการกำหนดขึ้นอีกทั้งยังหมายรวมถึง
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h6>ระดับที่ 1 :
                                    แสดงความมุ่งมั่นและกระตือรือร้นที่จะปฏิบัติราชการให้ดี(แสดงความพยายามในการทำงานให้ดี)
                                </h6>
                            </div>
                            <div class="col-md-1">
                                <p>1.1</p>
                        ...
                        @elseif ($level == 3)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ปรับปรุงวิธีการที่ทำให้ทำงานได้ดีขึ้น เร็วขึ้น มีคุณภาพดีขึ้น มีประสิทธิภาพมากขึ้น
                                    หรือทำให้ผู้รับบริการพึงพอใจมากขึ้น
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group input-group-sm mb-2">
                                        <label class="input-group-text" for="inputGroupSelect01">คะแนน</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>คำอธิบาย : ความตั้งใจและความพยายามของข้าราชการในการให้บริการต่อประชาชน ข้าราชการ
                                    หรือหน่วยงานอื่นๆ ที่เกี่ยวข้อง</p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ประสานงานภายในหน่วยงานและหน่วยงานที่เกี่ยวข้อง
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                รับเป็นธุระ ช่วยแก้ปัญหาหรือหาแนวทางแก้ไขปัญหาที่เกิดขึ้นแก่ผู้รับบริการอย่างรวดเร็ว
                            ...
                            <div class="col-md-9">
                                ดูแลให้ผู้รับบริการได้รับความพึงพอใจ และนำข้อขัดข้องใดๆ
                                ในการให้บริการไปพัฒนาการให้บริการให้ดียิ่งขึ้น
                            </div>
                            <div class="col-md-2">
                                <div class="input-group input-group-sm mb-2">
                                    <label class="input-group-text" for="score">คะแนน</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h6>ระดับที่ 3 : แสดงสมรรถนะระดับที่ 2 และให้บริการที่เกินความคาดหวัง
                                    แม้ต้องใช้เวลาหรือความพยายามอย่างมาก</h6>
                            </div>
                            <div class="col-md-1">
                                <p>2.7</p>
                            ...
                            <div class="col-md-9">
                                ให้ข้อมูล ข่าวสาร ที่เกี่ยวข้องกับงานที่กำลังให้บริการอยู่ ซึ่งเป็นประโยชน์แก่ผู้รับบริการ
                                แม้ว่าผู้รับบริการจะไม่ได้ถามถึง หรือไม่ทราบมาก่อน
                            </div>
                            <div class="col-md-2">
                                <div class="input-group input-group-sm mb-2">
                                    <label class="input-group-text" for="score">คะแนน</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>คำอธิบาย : ความสนใจใฝ่รู้ สั่งสม ความรู้ความสามารถของตนในการปฏิบัติงานราชการ ด้วยการศึกษา
                                    ค้นคว้า และพัฒนาตนเองอย่างต่อเนื่อง
                                    จนสามารถประยุกต์ใช้ความรู้เชิงวิชาการและเทคโนโลยีต่างๆ
                                    เข้ากับการปฏิบัติงานให้เกิดผลสัมฤทธิ์</p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ติดตามเทคโนโลยีและความรู้ใหม่ๆ อยู่เสมอ ด้วยการสืบค้นข้อมูลจากแหล่งต่างๆ
                                ที่จะเป็นประโยชน์ต่อการปฏิบัติราชการ
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h6>ระดับที่ 2 : แสดงสมรรถนะระดับที่ 1 และมีความรู้ในวิชาการและเทคโนโลยีใหม่ๆ
                                    ในสาขาอาชีพของตน</h6>
                            </div>
                            <div class="col-md-1">
                                <p>3.4</p>
                            ...
                            <div class="col-md-9">
                                รอบรู้ในเทคโนโลยีหรือองค์ความรู้ใหม่ๆ ในสาขาอาชีพของตน หรือที่เกี่ยวข้อง
                                ซึ่งอาจมีผลกระทบต่อการปฏิบัติหน้าที่ราชการของตน
                            </div>
                            <div class="col-md-2">
                                <div class="input-group input-group-sm mb-2">
                                    <label class="input-group-text" for="score">คะแนน</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h6>ระดับที่ 3 : แสดงสมรรถนะระดับที่ 2 และสามารถนำความรู้ วิทยาการ หรือเทคโนโลยีใหม่ๆ
                                    มาปรับใช้กับการปฏิบัติหน้าที่ราชการ</h6>
                            </div>
                            <div class="col-md-1">
                                <p>3.6</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>คำอธิบาย : การดำรงตนและประพฤติปฏิบัติอย่างถูกต้องเหมาะสมทั้งตามกฎหมาย คุณธรรม
                                    จรรยาบรรณแห่งวิชาชีพ และจรรยาบรรณข้าราชการเพื่อรักษาศักดิ์ศรีแห่งความเป็นข้าราชการ</p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ยึดมั่นในหลักการ จรรยาบรรณแห่งวิชาชีพ และจรรยาข้าราชการ ไม่เบี่ยงเบนด้วยอคติหรือผลประโยชน์
                                กล้ารับผิด และรับผิดชอบ
                            </div>
                            <div class="col-md-2">
                                <div class="input-group input-group-sm mb-2">
                                    <label class="input-group-text" for="score">คะแนน</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>คำอธิบาย : ความตั้งใจที่จะทำงานร่วมกับผู้อื่น เป็นส่วนหนึ่งในทีมงาน หน่วยงาน
                                    หรือส่วนราชการ โดยผู้ปฏิบัติมีฐานะเป็นสมาชิกในทีม ไม่จำเป็นต้องมีฐานะหัวหน้าทีม
                                    รวมทั้งความสามารถในการสร้างและรักษาสัมพันธภาพกับสมาชิกในทีม</p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <p>กล่าวถึงเพื่อนร่วมงานในเชิงสร้างสรรค์ และแสดงความเชื่อมั่นในศักยภาพของเพื่อนร่วมทีม
                                    ทั้งต่อหน้าและลับหลัง</p>
                            </div>
                            <div class="col-md-2">
                                <div class="input-group input-group-sm mb-2">
                                    <label class="input-group-text" for="score">คะแนน</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <p>ประสานและส่งเสริมสัมพันธภาพอันดีในทีม
                                    เพื่อสนับสนุนการทำงานร่วมกันให้มีประสิทธิภาพยิ่งขึ้น</p>
                            </div>
                            <div class="col-md-2">
                                <div class="input-group input-group-sm mb-2">
                                    <label class="input-group-text" for="score">คะแนน</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>คำอธิบาย : การรับรู้ถึงข้อแตกต่างทางวัฒนธรรม และสามารถประยุกต์ความเข้าใจ
                                    เพื่อสร้างสัมพันธภาพระหว่างกันได้</p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h6>ระดับที่ 2 : แสดงสมรรถนะระดับที่ 1 และเข้าใจ
                                        รวมทั้งปรับตัวให้สอดคล้องกับวัฒนธรรมใหม่</h6>
                                </div>
                                <div class="col-md-1">
                                    <p>6.3</p>
                                ...
                                <div class="col-md-9">
                                    <p>เข้าใจมารยาท กาลเทศะ ตลอดจนธรรมเนียมปฏิบัติของวัฒนธรรมที่แตกต่าง
                                        และพยายามปรับตัวให้สอดคล้อง</p>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group input-group-sm mb-2">
                                        <label class="input-group-text" for="score">คะแนน</label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h6>ระดับที่ 3 : แสดงสมรรถนะระดับที่ 2 และเข้าใจในวัฒนธรรมต่าง ๆ อย่างลึกซึ้ง
                                        รวมทั้งแสดงออกได้อย่างเหมาะสมกับสถานการณ์</h6>
                                </div>
                                <div class="col-md-1">
                                    <p>6.5</p>
                                ...
                                <div class="col-md-9">
                                    <p>ไม่ตัดสินผู้อื่นจากความแตกต่างทางวัฒนธรรม แต่ต้องพยายามทำความเข้าใจ
                                        เพื่อให้สามารถทำงานร่วมกันได้</p>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group input-group-sm mb-2">
                                        <label class="input-group-text" for="score">คะแนน</label>
